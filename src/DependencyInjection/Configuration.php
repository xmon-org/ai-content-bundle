    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('tasks')
                    ->addDefaultsIfNotSet()
                    ->info('Configure default and allowed models per task type')
                    ->children()
                        ->arrayNode('news_content')
                            ->addDefaultsIfNotSet()
                            ->info('Models for generating news article content from RSS feeds')
                            ->children()
                                ->scalarNode('default_model')
                                    ->defaultValue('claude')
                                    ->info('Default model for news content generation')
                                ->end()
                                ->arrayNode('allowed_models')
                                    ->scalarPrototype()->end()
                                    ->defaultValue(['claude', 'gemini', 'openai', 'gemini-fast', 'mistral'])
                                    ->info('List of models allowed for this task')
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('image_prompt')
                            ...
                            ->children()
                                ->scalarNode('default_model')
                                    ...
                                    ->info('Default model for image prompt generation')
                                ->end()
                                ->arrayNode('allowed_models')
                                    ->scalarPrototype()->end()
                                    ->defaultValue(['openai-fast', 'gemini-fast', 'mistral'])
                                    ->info('List of models allowed for this task')
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('image_generation')
                            ...
                            ->children()
                                ->scalarNode('default_model')
                                    ->defaultValue('gptimage')
                                    ->info('Default model for image generation')
                                ->end()
                                ->arrayNode('allowed_models')
                                    ->scalarPrototype()->end()
                                    ->defaultValue(['flux', 'gptimage', 'seedream', 'nanobanana', 'turbo'])
                                    ->info('List of models allowed for this task')
                                ->end()
                            ->end()
                        ->end()
